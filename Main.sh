...
MARTe2_DIR=/opt/MARTe2-git/MARTe2
fi
if [ -z ${MARTe2_Components_DIR+x} ]; then 
#export MARTe2_Components_DIR=~/Projects/MARTe2-components
export MARTe2_Components_DIR=/opt/MARTe2-git/MARTe2-components
fi

export MARTe2_Demos_DIR=/opt/MARTe2-git/MARTe2-demos-padova
